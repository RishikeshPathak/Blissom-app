              ...
              <div class="mt-8 card card-plain">
                ...
                <div class="card-body">
                  <form role="form" class="text-start" @submit.prevent="handleSignIn">
                    <label>Email</label>
                    <vsud-input v-model="email" type="email" placeholder="Email" name="email" />
                    <label>Password</label>
                    <vsud-input v-model="password" type="password" placeholder="Password" name="password" />
                    <vsud-switch id="rememberMe" v-model="rememberMe">Remember me</vsud-switch>
                    <div class="text-center">
                      <vsud-button
                        ...
                        :disabled="loading"
                        type="submit"
                      >{{ loading ? 'Loading...' : 'Sign in' }}</vsud-button>
                    </div>
                  </form>
                </div>
